...
<a href="/projects/{slug}" class="no-underline">
    <div class="relative h-72 w-72 group transition-transform hover:transform hover:-translate-x-1 hover:-translate-y-1">
        ...
        <div class="absolute group-hover:left-4 group-hover:top-4 transition-all left-2 top-2 h-[95%] w-[95%] outline-dashed outline-offset-2 outline-[4px] outline-blue-500"></div>

        <!-- PORTFOLIO ITEMS -->
        <div class="relative flex h-72 w-72 justify-center border-[1.5px] border-blue-500 bg-white shadow-frame">
